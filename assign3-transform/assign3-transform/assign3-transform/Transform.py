...
if __name__ == '__main__':
    ...
    # encrypting the twain text into pig latin:
    # doTransform("-pig", PigLatin.encrypt)

    # translating the pig latin version of the twain text back into English:
    # doTransform("-upg", PigLatin.decrypt)

    # using the caesar cipher to encrypt the twain text by a shift of 18:
    # CaesarCipher.setShift(18)
    # doTransform("-csr", CaesarCipher.encrypt)

    # # testing to see that the finShift function works correctly:
    ...
    # print(shift)
    #
    # # finding the shift used to encrypt decryptme
